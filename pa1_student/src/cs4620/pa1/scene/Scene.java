...
public class Scene
{
	...
	private enum NodeType { Transform, Mesh, Light };
	...
	public void traverse (SceneNode node, GL2 gl, boolean forPicking) {
		...
		if(node.getClass().equals(MeshNode.class)) type = NodeType.Mesh;
		else if(node.getClass().equals(LightNode.class)) type = NodeType.Light;
		
		//Implement node
		if(type.equals(NodeType.Light)){
			//load identity and shit
		} else {
