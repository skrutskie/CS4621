...
public abstract class Camera {
  ...
  //All the camera parameters
	...
	/**
	 * Return two points that defines a line from the eye to a point
	 * with the given normalized device coordinate.
	 */
	 ...
	 * on the plane perpendiculat to the image plane that contains planePosition.
	 */
