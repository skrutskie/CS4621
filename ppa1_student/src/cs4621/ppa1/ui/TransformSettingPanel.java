...
public class TransformSettingPanel extends JPanel implements ChangeListener
{
	...
	{
	    tX = new JSpinner(new SpinnerNumberModel(0.0, -10000.0, 10000.0, 0.1));
	    tY = new JSpinner(new SpinnerNumberModel(0.0, -10000.0, 10000.0, 0.1));
	    tZ = new JSpinner(new SpinnerNumberModel(0.0, -10000.0, 10000.0, 0.1));
	    ...
	    sX = new JSpinner(new SpinnerNumberModel(1.0, -10000.0, 10000.0, 0.1));
	    sY = new JSpinner(new SpinnerNumberModel(1.0, -10000.0, 10000.0, 0.1));
	    sZ = new JSpinner(new SpinnerNumberModel(1.0, -10000.0, 10000.0, 0.1));
