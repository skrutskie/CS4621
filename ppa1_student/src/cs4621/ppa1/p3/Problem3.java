...
import cs4621.ppa1.scene.HouseScene;
...
import cs4621.ppa1.scene.SolarSystemScene;
...

{
	...
	SliderPanel toleranceSliderPanel;
	...
	public Problem3() {
		super("CS 4621/5621 Programming Assignment 1 / Problem 3");
		...
		toleranceSliderPanel = new SliderPanel(this, -1.5f, -0.25f, 0.133f, true, 1000, "0.000");
		...
		getContentPane().add(timeSliderPanel, BorderLayout.WEST);
	...
	{
		return toleranceSliderPanel.getValue();
	}
	...
	public void stateChanged(ChangeEvent e) {
		...
		{
			animateScene();
			transformSettingPanel.externalUpdate();
		}
	 ...
	 */
	protected void openAnimatedScene(Scene newScene)
	{
		scene = newScene;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (cmd == null) {
			...
			openAnimatedScene(new SolarSystemScene());
		}
		else if (cmd.equals(HOUSE_SCENE_MENU_TEXT)) {
			openAnimatedScene(new HouseScene());
		}
